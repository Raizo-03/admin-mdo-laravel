...
<div class="space-y-5 ml-10">
    ...
    <div class="flex items-center space-x-6 bg-white shadow-lg rounded-xl p-6 w-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <p class="text-2xl font-bold text-gray-500">Name</p>
                <p class="text-xl text-gray-800">
                    {{ $admin->title ? $admin->title . '. ' : ' ' }}{{ $admin->name ?? 'No name provided' }}
                </p>
            </div>

            <div>
                <p class="text-2xl font-bold text-gray-500">Username</p>
                <p class="text-xl  text-gray-800">{{ $admin->username }}</p>
            </div>

            <div>
                <p class="text-2xl font-bold text-gray-500">Email</p>
                <p class="text-xl text-gray-800">{{ $admin->email ?? 'No email provided' }}</p>
            </div>

            <div>
                <p class="text-2xl font-bold text-gray-500">Position</p>
                <p class="text-xl  text-gray-800">{{ $admin->role ?? 'admin' }}</p>
            </div>
        </div>
