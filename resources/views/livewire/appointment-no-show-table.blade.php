<div>
   ...
   {{-- Date Range Filter --}}
    ...
    <div class="flex items-center gap-4 mb-4">
        <input type="text" id="searchInput" placeholder="Search no-show appointment..." class="w-full px-4 py-2 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-900 text-white">
    </div>
    ...
    <div class="flex items-center gap-4 mb-4">
        <div class="bg-white shadow-md rounded-lg px-3 py-2 h-55 flex items-center w-3xl">
            ...
            <div>
                <h3 class="text-gray-600 text-l mr-1">Total No-Show Appointments</h3>
                <p class="text-l font-bold text-blue-600">{{ $noshowAppointmentCount }}</p>
            </div>
        </div>
    </div>
                    ...
                    @foreach ($appointments as $index => $appointment)
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                    <a href="{{ route('appointments.noShow.show', $appointment->booking_id) }}" class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded-md mr-1">
                                        View
                                    </a>
            ...
            <div class="mb-4">
                ...
                <div class="flex flex-col space-y-2">
                    <label class="inline-flex items-center">
                        <input type="radio" wire:model="newStatus" value="Approved" class="form-radio h-5 w-5 text-blue-600">
                        <span class="ml-2 text-gray-700">Confirmed</span>
                    </label>
                    <label class="inline-flex items-center">
                        <input type="radio" wire:model="newStatus" value="Completed" class="form-radio h-5 w-5 text-red-600">
...
<script>
        function downloadData(format) {
            ...
            fetch(`{{ route('noshowappointments.export') }}?format=${format}`, {
                method: 'GET',
                headers: {
