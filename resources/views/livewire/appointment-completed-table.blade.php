<div>
    ...
    <h1 class="text-3xl font-bold text-white mb-4">Completed Appointments</h1>
    <p class="text-gray-400 mb-4">Manage Completed Appointments</p>
   ...
   {{-- Date Range Filter --}}
    ...
    <div class="flex items-center gap-4 mb-4">
        <input type="text" id="searchInput" placeholder="Search completed appointment..." class="w-full px-4 py-2 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-900 text-white">
    </div>
    ...
    <div class="flex items-center gap-4 mb-4">
        <div class="bg-white shadow-md rounded-lg px-3 py-2 h-55 flex items-center w-3xl">
            ...
            <div>
                <h3 class="text-gray-600 text-l mr-1">Total Completed Appointments</h3>
                <p class="text-l font-bold text-blue-600">{{ $completedAppointmentsCount }}</p>
            </div>
        </div>
    </div>
                    ...
                    @foreach ($appointments as $index => $appointment)
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                    <a href="{{ route('appointments.completed.show', $appointment->booking_id) }}" class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded-md mr-1">
                                        View
                                    </a>
